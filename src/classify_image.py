...
def maybe_download_and_extract():
  ...
  dest_directory = '/tmp/imagenet/' #FLAGS.model_dir
...
if __name__ == '__main__':
  ...
  #print (sys.argv[0],"<----->",setup_args())
  tf.app.run(main=tf_model_download, argv=[sys.argv[0]] + setup_args())